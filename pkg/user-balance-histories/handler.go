...
func (h *BalanceHistoryHandler) Check(c echo.Context) error {
	...
	if err != nil {
		log.Println("[balances] [handler] error getting balance history by username, err: ", err.Error())
